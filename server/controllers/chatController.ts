...
${emotionContext ? `User's recent emotion history:\n${emotionContext}` : 'User has no recent emotion history yet.'}`;
        ...
        if (!response.ok) {
            ...
            // Return a graceful fallback instead of throwing a 500
            res.json({
                reply: "I'm here to listen and support you. 💜 While I gather my thoughts, feel free to reflect on how you're feeling today — sometimes just naming an emotion helps!"
            });
            return;
        }
